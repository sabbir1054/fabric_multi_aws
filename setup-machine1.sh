...
command -v cryptogen >/dev/null 2>&1 || print_error "cryptogen not found. Please install Hyperledger Fabric binaries."
command -v configtxgen >/dev/null 2>&1 || print_error "configtxgen not found. Please install Hyperledger Fabric binaries."
