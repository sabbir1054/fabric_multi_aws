...
- **AWS Public IP**: `54.79.85.38` (Already configured)
...
scp -r ./fabric-network ubuntu@54.79.85.38:~/
```

#### 2. SSH to AWS and make scripts executable

```bash
ssh ubuntu@54.79.85.38
cd ~/fabric-network
chmod +x *.sh
```
...
ping 54.79.85.38
telnet 54.79.85.38 7050
telnet 54.79.85.38 7051
```
